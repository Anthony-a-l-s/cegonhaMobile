...
export default class CenterMedicalScreen extends React.Component {
  ...
  goEdit = async id => {
    ...
    this.props.navigation.push('AdminEditHospital');
  };
  goDelete = async id => {
    api
    ...
    this.props.navigation.navigate('AdminFindScreen')
    this.props.navigation.navigate('MedicalCenterMain')
    ...
    return (
      <View
        ...
        <View style={ContainerStyles.containerPasswordBottom}>
          <Text style={TextStyles.mainBlueText}>Edite um Centro Médico</Text>
          <Text style={TextStyles.mainGreenText}>
            Digite o nome e procure o centro
          </Text>
          <Text style={TextStyles.subGreenText}>médico que irá editar</Text>
        </View>
